 ...
 */
@TableName("anliku")
public class AnlikuEntity<T> implements Serializable {
	 ...
	 * 设置：相关律师
	 */
	public void setXiangguanlvshi(String xiangguanlvshi) {
		this.xiangguanlvshi = xiangguanlvshi;
	}
	/**
	 * 获取：相关律师
	 */
	public String getXiangguanlvshi() {
		return xiangguanlvshi;
	}
	/**
	 * 设置：封面
	 */
