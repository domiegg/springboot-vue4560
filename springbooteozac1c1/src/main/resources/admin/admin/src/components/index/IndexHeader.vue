<template>
	<div class="navbar">
		<div class="title" :style='{"padding":"0 5px","margin":"0px","alignItems":"center","textAlign":"center","display":"flex","justifyContent":"center","overflow":"hidden","top":"0","left":"0px","background":"#1e3c4f","width":"210px","position":"absolute","order":"3","height":"68px"}'>
			...
			<span class="title-name" :style='{"padding":"0px","lineHeight":"1.2","fontSize":"15px","color":"#fff","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
